...
type SightSource struct {
	...
	SourceEntry      string                     `protobuf:"bytes,6,opt,name=source_entry,json=sourceEntry" json:"source_entry,omitempty"`
	...
	Interactions     map[string]int32           `protobuf:"bytes,10,rep,name=interactions" json:"interactions,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"varint,2,opt,name=value"`
}
...
func (m *SightSource) GetSourceEntry() string {
	if m != nil {
		return m.SourceEntry
	}
	return ""
}
...
type Sight struct {
	...
	Lookups          map[string]string          `protobuf:"bytes,9,rep,name=lookups" json:"lookups,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
}
...
func (m *Sight) GetLookups() map[string]string {
	if m != nil {
		return m.Lookups
	}
	return nil
...
var fileDescriptor0 = []byte{
	...
	,
}
